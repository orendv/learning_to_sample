...
parser.add_argument('--log_dir', default='log/SNET64', help='Log dir [default: log/SNET64]')
...
def train():
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:' + str(GPU_INDEX)):
            ...
            classifier_params = [v for v in global_vars if not v.name.startswith('sampler')]
