...
def plot_3d_point_cloud(x, y, z, show=True, show_axis=True, in_u_sphere=True, marker='.', c='b', s=8, alpha=.8, figsize=(5, 5), elev=10, azim=240, miv=None, mav=None, squeeze=0.7, axis=None, title=None, *args, **kwargs):
