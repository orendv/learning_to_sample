...
returns:
    ...
    batch_size = idx_shape[0] # use static shape instead of dynamic shape (tf.shape(idx)[0])
    npoint = idx_shape[1] # # use static shape instead of dynamic shape (tf.shape(idx)[1])
